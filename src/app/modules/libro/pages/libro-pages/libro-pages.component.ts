...
export class LibroPagesComponent implements OnInit {
  ...
  obtenerNombreCategoria(id: number): string {
    ...
    return categoria ? categoria.nombrec : '';
  }
  //----------------------------------------------------------------------------------------
  ...
  cargarDatosLibroParaEdicion(id: number) {
    ...
    this.nuevoLibro.cliente = libroParaEditar.autor.id;
    this.nuevoLibro.paquete = libroParaEditar.editorial.id;
    this.nuevoLibro.empleado = libroParaEditar.categoria.id;
